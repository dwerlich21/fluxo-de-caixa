...
(function (global, factory) {
    ...
    function getClippingParents(el) {
        var parents = [];
        while (el instanceof HTMLElement) { // will stop when gets to aep or null
            var computedStyle = window.getComputedStyle(el);
    ...
    */
    var PositionCache = /** @class */ (function () {
        ...
        // Given a left offset (from aep left), returns the index of the el that it horizontally intersects.
        ...
        // Given a top offset (from aep top), returns the index of the el that it vertically intersects.
        // If no intersection is made, returns undefined.
